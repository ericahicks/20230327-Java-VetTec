...
public class MoreEnthuwareReview {
	...
	// - other modifiers:
	// - synchronized parent method can be a synchronized or unsynchronized
	////////////////////////////////////////////////////////////////////////////// child
	////////////////////////////////////////////////////////////////////////////// method
	...
	public static void main(String[] args) {
		...
		int[][] x[], y, z[];
		/*
		 * same as saying int[][][] x; int[][] y int[][][] z
		 */
		// x has 3 dimensions
		// y has 2 dimension
		// z has 3 dimensions
		...
		int[] array4[];
		/*
		 * array1 1D array2 2D array3 2D array4 2D array5 2D
		 */
...
//	array2 = array1; // type mismatch
		...
		/*
		 * What data types can be used in a switch statement? - byte or Byte -
		 * char or Character - short or Short - int or Integer - String - Enum
		 * types
		 * 
		 * What data types can be used in a case statement given the switch
		 * statement is: char c switch (c) case can be: - char - int in a valid
		 * range of 0 to 2^15 - short in a valid range - bye in a valid range
		 * 
		 * 
		 * 
		 */
		...
		/*
		 * - char - int in a valid range of 0 to 2^15 - short in a valid range -
...
//		myChar = (byte) -127;
		...
		double g = 0.75;
		// Which are allowed?
		ch = (char) s; // s; is not allowed because could be out of range of
						// valid char values
//		s = ch; // ch;  is not allowed because could be out of range
...
//		 s = Character.MAX_VALUE; // TOO LARGE
		...
		ch = Short.MAX_VALUE; // Why does this one work? 32000 is the max which
								// fits in the range 0-64000
//		 ch = Short.MIN_VALUE; // Why doesn't this work? -32000 is out of the range 0-64000
	...
	public void switchTest(byte x) {
		switch (x) {
		case 'b': // 1 'a' is 97 this means the decimal value of b is 98 is that
					// in the range -128 to 127
		default: // 2 default can be anywhere, but will always run only if no
					// case matches
		case -2: // 3
		case 80: // 4
		}
...
class Parent {
	...
	// overloading
	protected static Parent doStuff(int x) throws Exception {
		return null;
	} // must have different params than above
...
class Child extends Parent {
	...
	// redefining the static method is not called overriding it is called
	// "shadowing"
	public static void update() {
	} // static method body is chosen at compile time
}
