package com.skillstorm.training.day5.optionals;
...
//		System.out.println(opt1.get()); // NoSuchElementException: No value present
...
//		System.out.println(empty.get());
		...
		// Choice 4:
		System.out.println(
				opt1.orElseGet(() -> "Nothing here to see on this beautiful "
						+ LocalDate.now().getDayOfWeek()));
		System.out.println(opt.orElseGet(() -> "Nothing here to see"));
...
*/
		...
		drinks.add(new Drink("mountian dew", 46));
...
class Drink {
	...
	public static Drink getLeastSugary(List<Drink> drinks) {
		// create a stream and use .reduce to get an Optional
		return drinks.stream().reduce((d1, d2) -> {
			if (d1.getSugar() < d2.getSugar())
				return d1;
			return d2;
